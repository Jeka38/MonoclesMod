...
public class MessageArchiveService implements OnAdvancedStreamFeaturesLoaded {
    ...
    private void processFin(Query query, Element fin) {
        ...
        boolean abort = (!query.isCatchup() && query.getTotalCount() >= Config.PAGE_SIZE) || query.getTotalCount() >= (query.isCatchup() ? Config.MAM_MAX_CATCHUP_MESSAGES : Config.MAM_MAX_MESSAGES);
