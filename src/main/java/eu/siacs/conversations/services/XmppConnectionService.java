...
public class XmppConnectionService extends Service {
    ...
    File dirStickers = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS) + File.separator + APP_DIRECTORY + File.separator + "Smiles");
    //Gifspaths
    private File[] files;
